...
// ────────────────────────────────────────────────────────────────────────────
// QA MLM Ronda 4 — Tests para bugs M-01 / M-02
// ────────────────────────────────────────────────────────────────────────────
// NOTA: Estos tests se agregan fuera de la clase porque el archivo ya cierra
// la clase en la línea anterior. Se crea una nueva clase de test dedicada.
...
/**
 * Tests QA Ronda 4 — Módulo MLM
 * Cubre bugs M-01 (get_referral_rates lee JSON) y M-02 (respeta ltms_mlm_levels).
 */
class MLMReferralRatesTest extends LTMS_Unit_Test_Case {
    ...
    // ── M-01: la función lee ltms_referral_rates, no ltms_mlm_l1/l2/l3_rate ──
    ...
    public function test_get_referral_rates_ignores_mlm_l1_l2_l3_keys(): void {
        ...
        \LTMS_Core_Config::set( 'ltms_mlm_l1_rate', 0.99 ); // debe ignorarse
