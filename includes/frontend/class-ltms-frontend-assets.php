    ...
    private function localize_dashboard_script(): void {
        ...
        wp_localize_script( 'ltms-dashboard', 'ltmsDashboard', [
            ...
            'i18n'          => [
                ...
                // v2.9.71 P3-2: Onboarding strings localizadas.
                'ob_welcome'        => __( '¡Bienvenido a Lo Tengo!', 'ltms' ),
                'ob_subtitle'       => __( 'Completa estos pasos para aprovechar al máximo tu tienda.', 'ltms' ),
                'ob_email_title'    => __( 'Verifica tu email', 'ltms' ),
                'ob_email_done'     => __( 'Verificado', 'ltms' ),
                'ob_email_pending'  => __( 'Revisa tu bandeja de entrada (y spam) para confirmar tu cuenta.', 'ltms' ),
                'ob_kyc_title'      => __( 'Completa tu verificación de identidad (KYC)', 'ltms' ),
                'ob_kyc_action'     => __( 'Completar KYC', 'ltms' ),
                'ob_store_title'    => __( 'Configura tu tienda', 'ltms' ),
                'ob_store_done'     => __( 'Tienda configurada', 'ltms' ),
                'ob_store_pending'  => __( 'Añade logo, descripción y banner a tu tienda.', 'ltms' ),
                'ob_store_action'   => __( 'Configurar tienda', 'ltms' ),
                'ob_product_title'  => __( 'Publica tu primer producto', 'ltms' ),
                'ob_product_done'   => __( 'Ya tienes productos publicados', 'ltms' ),
                'ob_product_pending'=> __( 'Tu tienda aún no tiene productos visibles.', 'ltms' ),
                'ob_product_action' => __( 'Agregar producto', 'ltms' ),
                'kyc_none'       => __( 'Pendiente de iniciar', 'ltms' ),
                'kyc_pending'    => __( 'En revisión', 'ltms' ),
                'kyc_approved'   => __( 'Aprobado', 'ltms' ),
                'kyc_rejected'   => __( 'Rechazado — corrige y reenvía', 'ltms' ),
                'kyc_expired'    => __( 'Expirado — renueva', 'ltms' ),
            ],
