...
(function ($) {
        ...
        /* ── Navegación por filtros (CSP compliance — reemplaza inline onchange) ──
         * INTEGRATIONS-AUDIT P0 FIX: los inputs <input data-ltms-nav-url="..."> y
         * <select data-ltms-nav-select="1"> disparan navegación al cambiar. Antes
         * eran inline onchange="location.href=..." que violaban CSP script-src 'self'.
         */
