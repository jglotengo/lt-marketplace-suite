...
// AUDIT-PANEL-FN-03 (re-auditoría): vendor invoicing settings (Alegra/Siigo).
// v2.9.222: originalmente inline en view-settings.php. FASE2B P0 FIX (CSP) migration.
(function(){
    'use strict';
    var $ = jQuery;
    if (!$) return;
    ...
    $('#ltms-save-invoicing-btn').on('click', function() {
        ...
        $.post(ltmsDashboard.ajax_url, data, function(resp) {
