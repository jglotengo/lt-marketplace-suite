...
wp_localize_script( 'ltms-redi', 'ltmsRedi', [
    ...
    'strings' => [
        'explore_btn'    => __( 'Explorar Productos ReDi', 'ltms' ),
        'loading'        => __( 'Cargando...', 'ltms' ),
        'searching'      => __( 'Buscando productos disponibles...', 'ltms' ),
        'no_ajax_url'    => __( 'Error: no se pudo determinar la URL de AJAX.', 'ltms' ),
        'vendor_label'   => __( 'Vendedor:', 'ltms' ),
        'redi_rate_label'=> __( 'Tasa ReDi:', 'ltms' ),
        'no_products'    => __( 'No se encontraron productos ReDi disponibles en este momento.', 'ltms' ),
        'conn_error'     => __( 'Error de conexión. Intente nuevamente.', 'ltms' ),
        'paused'         => __( 'Pausado', 'ltms' ),
        'active'         => __( 'Activo', 'ltms' ),
        'pause'          => __( 'Pausar', 'ltms' ),
        'resume'         => __( 'Reanudar', 'ltms' ),
        'success'        => __( 'Éxito', 'ltms' ),
        'error'          => __( 'Error', 'ltms' ),
        'paused_msg'     => __( 'ReDi pausado. Los revendedores han sido notificados.', 'ltms' ),
        'resumed_msg'    => __( 'ReDi reanudado. Los revendedores han sido notificados.', 'ltms' ),
        'pause_err'      => __( 'Error al pausar.', 'ltms' ),
        'resume_err'     => __( 'Error al reanudar.', 'ltms' ),
    ],
] );
