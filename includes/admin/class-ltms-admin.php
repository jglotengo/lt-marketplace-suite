...
final class LTMS_Admin {
    ...
    public function register_menus(): void {
        ...
        $submenus = [
            ...
            // NOTA: 'Logística / Costos' (ltms-shipping-ledger) se registra
            // automaticamente via LTMS_Admin_Shipping_Ledger::init() llamada
            // desde class-ltms-kernel.php linea 266. NO duplicarlo aqui.
        ];
