<?php
/**
 * LTMS — Seeder catalogo DANE Colombia (DIVIPOLA)
 * 1121 municipios — columnas reales de produccion: dane_code, name, department
 *
 * Resuelve: checkout bloqueado en Colombia porque el catalogo DANE
 * (bkr_lt_co_dane_municipalities) solo tenia 44 de ~1100 municipios,
 * por lo que la mayoria de ciudades (incluida Cali) no pasaban la
 * validacion estricta de codigo DANE en LTMS_Frontend_Checkout_Municipality_Field.
 *
 * Idempotente: verifica dane_code antes de insertar, seguro de correr varias veces.
 *
 * Uso:
 *   wp --allow-root --path=/home/customer/www/lo-tengo.com.co/public_html \
 *      eval-file deploy/ltms-seed-dane.php
 */
...
$municipios = [
    ...
    ['18610', 'San José de Fragua', 'Caquetá'],
    ...
    ['25513', 'Venecia', 'Cundinamarca'],
    ['25518', 'Pacho', 'Cundinamarca'],
    ['25524', 'Paime', 'Cundinamarca'],
    ['25530', 'Pandi', 'Cundinamarca'],
    ['25535', 'Paratebueno', 'Cundinamarca'],
    ['25537', 'Pasca', 'Cundinamarca'],
    ...
    ['44143', 'Fonseca', 'La Guajira'],
    ['44217', 'Hatonuevo', 'La Guajira'],
    ...
    ['50573', 'Puerto Lleras', 'Meta'],
    ['50577', 'Puerto López', 'Meta'],
    ...
    ['52240', 'El Charco', 'Nariño'],
    ['52250', 'El Peñol', 'Nariño'],
    ['52254', 'El Rosario', 'Nariño'],
    ['52256', 'El Tablón de Gómez', 'Nariño'],
    ['52258', 'El Tambo', 'Nariño'],
    ['52281', 'Funes', 'Nariño'],
    ['52287', 'Guachucal', 'Nariño'],
    ['52290', 'Guaitarilla', 'Nariño'],
    ['52292', 'Gualmatán', 'Nariño'],
    ['52320', 'Iles', 'Nariño'],
    ['52323', 'Imués', 'Nariño'],
    ['52352', 'Ipiales', 'Nariño'],
    ['52354', 'La Cruz', 'Nariño'],
    ['52356', 'La Florida', 'Nariño'],
    ['52378', 'La Llanada', 'Nariño'],
    ['52381', 'La Tola', 'Nariño'],
    ['52385', 'La Unión', 'Nariño'],
    ['52390', 'Leiva', 'Nariño'],
    ['52399', 'Linares', 'Nariño'],
    ['52405', 'Los Andes', 'Nariño'],
    ['52411', 'Magüí', 'Nariño'],
    ['52418', 'Mallama', 'Nariño'],
    ['52427', 'Mosquera', 'Nariño'],
    ['52435', 'Nariño', 'Nariño'],
    ['52473', 'Olaya Herrera', 'Nariño'],
    ['52480', 'Ospina', 'Nariño'],
    ['52490', 'Francisco Pizarro', 'Nariño'],
    ['52506', 'Policarpa', 'Nariño'],
    ['52520', 'Potosí', 'Nariño'],
    ['52540', 'Providencia', 'Nariño'],
    ['52560', 'Puerres', 'Nariño'],
    ['52565', 'Pupiales', 'Nariño'],
    ['52573', 'Ricaurte', 'Nariño'],
    ['52585', 'Roberto Payán', 'Nariño'],
    ['52612', 'Samaniego', 'Nariño'],
    ['52621', 'Sandoná', 'Nariño'],
    ['52678', 'San Bernardo', 'Nariño'],
    ['52683', 'San Lorenzo', 'Nariño'],
    ['52685', 'San Pablo', 'Nariño'],
    ['52687', 'San Pedro de Cartago', 'Nariño'],
    ['52693', 'Santa Bárbara', 'Nariño'],
    ['52694', 'Santacruz', 'Nariño'],
    ['52696', 'Sapuyes', 'Nariño'],
    ['52720', 'Taminango', 'Nariño'],
    ['52786', 'Tangua', 'Nariño'],
    ['52788', 'San Andrés de Tumaco', 'Nariño'],
    ['52835', 'Túquerres', 'Nariño'],
    ['52838', 'Yacuanquer', 'Nariño'],
    ...
    ['70221', 'Coveñas', 'Sucre'],
    ['70230', 'Galeras', 'Sucre'],
    ['70235', 'Don Gabriel', 'Sucre'],
    ['70265', 'El Roble', 'Sucre'],
...
foreach ( $municipios as [ $code, $name, $dept ] ) {
    $exists = $wpdb->get_var( $wpdb->prepare(
        "SELECT id FROM `{$table}` WHERE dane_code = %s", $code
    ) );
    if ( $exists ) {
        $skipped++;
        continue;
    ...
    if ( false === $r ) {
        $errors++;
        echo "ERROR (" . $code . "): " . $wpdb->last_error . "\n";
    } else {
        $inserted++;
    }
}
...
echo "Ya existian (omitidos): {$skipped}\n";
echo "Errores: {$errors}\n";
echo "Total filas en catalogo ahora: {$total}\n";
echo "=== DANE seeder completado ===\n";
