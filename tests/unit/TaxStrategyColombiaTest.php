...
class TaxStrategyColombiaTest extends LTMS_Unit_Test_Case {
        ...
        // LF-1 FIX (v2.9.11): UVT actualizado a valor 2026 ($52.752) — antes era 49799 (2024).
        private const UVT                   = 52752.0;
        ...
        private const MIN_COMPRAS           = self::UVT * 10.666;   // ≈ 562,663 COP (2026 UVT)
        private const MIN_SERVICIOS         = self::UVT * 2.666;    // ≈ 140,633 COP (2026 UVT)
        private const MIN_HONORARIOS        = self::UVT * 1.0;      // ≈  52,752 COP (2026 UVT)
        ...
        public function test_reteiva_gran_contribuyente( float $gross, float $reteiva_esperado ): void {
                $result = $this->strategy->calculate(
                        ...
                        // v2.9.31: reteiva requiere vendor_responsible_iva, que solo es true
                        // si vendor_regime ∈ ['common', 'special', 'gran_contribuyente'].
                        [ 'tax_regime' => 'common' ]
                );
